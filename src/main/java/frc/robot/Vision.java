...
public class Vision {
    ...
    final Distance k_xOffset = Inch.of(0); //front/back offest of camera to robot center (positive is forward, negative is backward)
    final Distance k_yOffset = Inch.of(-(27.25/2-1.125)); //left/right offset of camera to robot center (positive is left, negative is right)
    final Distance k_zOffset = Inch.of(22-6.75); //vertical offset of camera to robot center (positive is up, negative is down)
